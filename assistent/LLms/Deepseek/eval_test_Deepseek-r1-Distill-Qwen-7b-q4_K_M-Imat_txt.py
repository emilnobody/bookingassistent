...
llm_prediction_folder= os.path.normpath(os.path.join(config.DEEPSEEK_FOLDER,"predictions"))
...
output_file_path=os.path.normpath(os.path.join(config.DEEPSEEK_FOLDER,"evaluations","zero_shot",output_filename))
