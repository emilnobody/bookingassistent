...
llm_prediction_folder= os.path.normpath(os.path.join(config.MISTARL_FOLDER,"predictions","few_shot"))
...
output_file_path=os.path.normpath(os.path.join(config.MISTARL_FOLDER,"evaluations","few_shot",output_filename))
