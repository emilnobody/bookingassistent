...
output_file_path = os.path.normpath(
    os.path.join(config.MISTARL_FOLDER, "evaluations", "zero_shot", output_filename)
)
eval.save_evaluation_results(
    metrics_results, micro_metrics, macro_metrics, output_file_path
)
