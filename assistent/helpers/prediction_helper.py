...
def run_predictions(ground_truth_data, llm_prediction_folder, modelkey, llm):
    ...
    for entry in ground_truth_data:
        ...
        if "deepseek" in modelkey:
            generated_deepseek_text = outputs["choices"][0]["message"]["content"]
...
def run_predictions_few_shot(ground_truth_data, llm_prediction_folder, modelkey, llm):
    """Führt die Predictions aus"""
    shot = "few"
    failed_format_file = create_failed_format_file_path(
        llm_prediction_folder, modelkey, shot
